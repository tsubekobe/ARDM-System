...
Begin Form
    ...
    End
    NameMap = Begin
        0x0acc0e5500000000528ee5700831524cbe4a2f755dd26479000000003b32cc4d ,
        0xb634e44028162901b80529015100bd652d8a0d540000000000005fef0cc3ded0 ,
        0x0842b4ce633f88042f67000000009fabad58ce2ae6408099fa037060ef005400 ,
        ...
        0x4400000000000000000000000000000000000000000000000c00000004000000 ,
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    Name ="cbo所属"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT Tコード管理.コード名称 FROM Tコード管理 WHERE (((Tコード管理.コードID)=2)) ORDER BY Tコード管理.コード; "
                    AfterUpdate ="[Event Procedure]"
                End
                Begin TextBox
                    OverlapFlags =247
